  ...
  return (
    <div className="min-h-screen bg-surface-secondary dark:bg-gray-900 pt-32 pb-20">
      <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
        <div className="bg-surface-primary dark:bg-surface-primary rounded-3xl border border-border-primary dark:border-border-primary shadow-xl overflow-hidden shadow-gray-200/50 dark:shadow-gray-900/50">
          {/* Color Banner */}
          ...
          <div className="p-8 md:p-12">
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 mb-12">
              <div>
                ...
                <p className="text-text-secondary dark:text-text-muted text-lg leading-relaxed max-w-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="md:col-span-1 space-y-8">
                <div>
                  <h2 className="text-sm font-bold text-text-muted uppercase tracking-widest mb-4">Ficha Técnica</h2>
              ...
              <div className="md:col-span-2 space-y-6">
                <h2 className="text-sm font-bold text-text-muted uppercase tracking-widest mb-4">Participantes del Proyecto</h2>

                {project.members && project.members.length > 0 ? (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {project.members.map((member: any) => (
                      <div key={member.id} className="flex items-center p-4 bg-surface-secondary dark:bg-surface-secondary rounded-2xl border border-border-primary dark:border-border-secondary hover:border-brand/30 transition-colors">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <span className="inline-block mt-0.5 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded-md bg-gray-200/50 text-text-secondary">
                              {member.role}
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="text-center py-12 bg-surface-secondary rounded-2xl border border-border-primary border-dashed">
