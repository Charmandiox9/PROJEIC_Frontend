              ...
              {project.isInstitutional && project.subject && (
                <>
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-gray-500 min-w-[120px]">Ramo (EIC)</span>
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div className="flex flex-col gap-1">
                        {project.subject.professors.map(prof => (
                          <span key={prof.id} className="text-sm font-medium text-gray-900 bg-gray-100 px-2 py-0.5 rounded-md w-fit">
                            {prof.name}
                          </span>
                        ))}
                      </div>
